...
//           </div>
//           <div className={`w-16 h-16 ${colors.light} rounded-2xl`}></div>
//         </div>
//       </div>
//     )
//   }
...
//   return (
//     <div className="card p-6 hover:scale-105 transition-transform duration-300 cursor-pointer group">
//       <div className="flex items-center justify-between">
//         <div className="flex-1">
...
//         {/* Icon */}
//         <div
//           className={`w-16 h-16 ${colors.light} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-md`}
//         >
//           <div
//             className={`w-12 h-12 bg-gradient-to-br ${colors.bg} rounded-xl flex items-center justify-center shadow-lg`}
//           >
...
//       {/* Bottom description if no trend */}
//       {!trend && description && (
