        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex justify-end gap-3 mt-6 pt-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={uploading}
              className="px-6 py-2.5 bg-teal-600 hover:bg-teal-700 text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
